...
export declare function intToBytes(value: IntegerType, byteLength: number): Uint8Array;
export declare function intToBigInt(value: IntegerType): bigint;
export declare function with0x(value: string): string;
export declare function without0x(value: string): string;
...
export declare function bytesToTwosBigInt(bytes: Uint8Array): bigint;
...
export declare function isInstance<T>(object: any, clazz: {
    new (...args: any[]): T;
}): object is T;
export declare function validateHash256(hex: string): boolean;
export {};
