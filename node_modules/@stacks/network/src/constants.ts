...
export enum AddressVersion {
  /** `P` â€” A single-sig address for mainnet (starting with `SP`) */
  MainnetSingleSig = 22,
  /** `M` â€” A multi-sig address for mainnet (starting with `SM`) */
  MainnetMultiSig = 20,
  /** `T` â€” A single-sig address for testnet (starting with `ST`) */
  TestnetSingleSig = 26,
  /** `N` â€” A multi-sig address for testnet (starting with `SN`) */
  TestnetMultiSig = 21,
}
