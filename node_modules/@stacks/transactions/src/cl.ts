...
// Primitives //////////////////////////////////////////////////////////////////
/**
 * `Cl.bool` â€” Creates a Clarity boolean type, represented as a JS object
 *
...
/**
 * `Cl.int` â€” Creates a Clarity `int` type, represented as a JS object
 *
...
/**
 * `Cl.uInt` â€” Creates a Clarity `uint` type, represented as a JS object
 *
...
/**
 * `Cl.principal` â€” Creates a Clarity principal type, represented as a JS object
...
/**
 * `Cl.address` â€” Creates a Clarity principal type, represented as a JS object
 * @param address - A Stacks address (optionally with a contract name in the string)
 *
...
/**
 * `Cl.contractPrincipal` â€” Creates a Clarity contract `principal` type, represented as a JS object
 *
...
/**
 * `Cl.standardPrincipal` â€” Creates a Clarity standard `principal` type, represented as a JS object
 *
...
// Sequences ///////////////////////////////////////////////////////////////////
/**
 * `Cl.list` â€” Creates a Clarity `list` type, represented as a JS object
 *
...
/**
 * `Cl.stringAscii` â€” Creates a Clarity `string-ascii` type, represented as a JS object
 *
...
/**
 * `Cl.stringUtf8` â€” Creates a Clarity `string-utf8` type, represented as a JS object
 *
...
/**
 * `Cl.buffer` â€” Creates a Clarity `buffer` type, represented as a JS object
 *
...
/**
 * `Cl.bufferFromHex` â€” Converts bytes (from a hex string) to a Clarity `buffer` type, represented as a JS object
...
/**
 * `Cl.bufferFromAscii` â€” Converts bytes (from an ASCII string) to a Clarity `buffer` type, represented as a JS object
...
/**
 * `Cl.bufferFromUtf8` â€” Converts bytes (from an UTF-8 string) to a Clarity `buffer` type, represented as a JS object
...
// Composites //////////////////////////////////////////////////////////////////
/**
 * `Cl.none` â€” Creates a Clarity optional `none` type, represented as a JS object
 *
...
/**
 * `Cl.some` â€” Creates a Clarity optional `some` type, represented as a JS object
 *
...
/**
 * `Cl.ok` â€” Creates a Clarity response `ok` type, represented as a JS object
 *
...
/**
 * `Cl.error` â€” Creates a Clarity response `error` type, represented as a JS object
 *
...
/**
 * `Cl.tuple` â€” Creates a Clarity `tuple` type, represented as a JS object
 *
...
// Methods /////////////////////////////////////////////////////////////////////
/**
 * `Cl.serialize` â€” Serializes a Clarity JS object to the equivalent hex-encoded representation
 *
...
/**
 * `Cl.deserialize` â€” Deserializes a hex string to the equivalent Clarity JS object
 *
