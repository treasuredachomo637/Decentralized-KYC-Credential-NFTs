...
/**
 * Not meant to be used directly. Start from `Pc.principal(â€¦)` instead.
 */
class PartialPcWithPrincipal {
   ...
   * Finalize with the chained `.ustx()` or `.ft(â€¦)` method.
   * @example
   * ```
   * import { Pc } from '@stacks/transactions';
   ...
   * Finalize with the chained `.nft(â€¦)` method.
   * @example
   * ```
   * import { Pc } from '@stacks/transactions';
   * Pc.principal('STB4â€¦K6.nft-contract').willSendAsset().nft('STB4â€¦K6.super-nft::super', uintCV(1));
   * ```
   */
  willSendAsset() {
   ...
   * ```
   * import { Pc } from '@stacks/transactions';
   * Pc.principal('STB4â€¦K6.nft-contract').willNotSendAsset().nft('STB4â€¦K6.super-nft::super', uintCV(1));
   * ```
   */
  willNotSendAsset() {
...
class PartialPcFtWithCode {
  ...
  /**
   * ### STX Post Condition
   * âš  Amount of STX is denoted in uSTX (micro-STX)
   */
  ...
  /**
   * ### Fungible Token Post Condition
   * âš  Amount of fungible tokens is denoted in the smallest unit of the token
   */
