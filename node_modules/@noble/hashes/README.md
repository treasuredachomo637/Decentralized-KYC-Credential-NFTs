...
- ðŸ”’ [**Audited**](#security) by an independent security firm: no vulnerabilities have been found
...
- ðŸŽ Ultra-fast, hand-optimized for caveats of JS engines
...
- ðŸª¶ Just 2.3k lines / 14KB gzipped. SHA256-only is 240 lines / 3KB gzipped
...
SHA384 32B x 463,606 ops/sec @ 2Î¼s/op
SHA512 32B x 467,945 ops/sec @ 2Î¼s/op
SHA3-256, keccak256, shake256 32B x 192,049 ops/sec @ 5Î¼s/op
Kangaroo12 32B x 318,066 ops/sec @ 3Î¼s/op
Marsupilami14 32B x 283,929 ops/sec @ 3Î¼s/op
BLAKE2b 32B x 352,112 ops/sec @ 2Î¼s/op
BLAKE2s 32B x 511,770 ops/sec @ 1Î¼s/op
BLAKE3 32B x 582,072 ops/sec @ 1Î¼s/op
RIPEMD160 32B x 1,230,012 ops/sec @ 813ns/op
HMAC-SHA256 32B x 238,663 ops/sec @ 4Î¼s/op
