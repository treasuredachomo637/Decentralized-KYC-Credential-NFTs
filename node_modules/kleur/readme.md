...
```
# All Colors
  ansi-colors  x 199,381 ops/sec Â±1.04% (96 runs sampled)
  chalk        x  12,107 ops/sec Â±2.07% (87 runs sampled)
  kleur        x 715,334 ops/sec Â±0.30% (93 runs sampled)

# Stacked colors
  ansi-colors  x 24,494 ops/sec Â±1.03% (93 runs sampled)
  chalk        x  2,650 ops/sec Â±2.06% (85 runs sampled)
  kleur        x 75,798 ops/sec Â±0.19% (97 runs sampled)

# Nested colors
  ansi-colors  x  77,766 ops/sec Â±0.32% (94 runs sampled)
  chalk        x   5,596 ops/sec Â±1.85% (86 runs sampled)
  kleur        x 137,660 ops/sec Â±0.31% (93 runs sampled)
```
